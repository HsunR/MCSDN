...
- [ ] **Phase 1: Admin Backend & Dark Theme** - JWT auth, article management, dark UI
- [ ] **Phase 2: Public Blog & Image Upload** - Public frontend, categories/tags, image storage
...
|-------|----------------|--------|-----------|
| 1. Admin Backend & Dark Theme | 0/- | Not started | - |
| 2. Public Blog & Image Upload | 0/- | Not started | - |
| 3. Comments | 0/- | Not started | - |
